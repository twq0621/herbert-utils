...
import net.snake.gamemodel.rankings.response.RankingResponse50334;
 ...
 * 
 */
@MsgCodeAnn(msgcode = 50335, accessLimit = 100)
public class RankingAchievementSimilarProcess50335 extends CharacterMsgProcessor implements IThreadProcessor {
	@Override
	public void process(Hero character, RequestMsg request) throws Exception {
		...
		// character 人物角色
		List<CharacterRanking> list = RankingManager.getInstance().getMapCharacterRankingChengjiu().get(character.getGrade());
		...
		RankingResponse50334 response50334 = new RankingResponse50334(list, mingci, pagecount);
		character.sendMsg(response50334);
