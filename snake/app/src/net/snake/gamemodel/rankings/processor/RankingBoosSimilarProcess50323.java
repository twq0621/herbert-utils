...
import net.snake.gamemodel.rankings.response.RankingResponse50320;
 ...
 * 
 */
@MsgCodeAnn(msgcode = 50323, accessLimit = 100)
public class RankingBoosSimilarProcess50323 extends CharacterMsgProcessor implements IThreadProcessor {
	@Override
	public void process(Hero character, RequestMsg request) throws Exception {
		...
		int pagecount = 0;
		// character 人物角色
		List<CharacterRanking> list = RankingManager.getInstance().getMapcharacterRankingBossList().get((int) character.getGrade());
		...
		RankingResponse50320 response50320 = new RankingResponse50320(list, mingci, pagecount);
		character.sendMsg(response50320);
