 ...
 * 
 */
@MsgCodeAnn(msgcode = 50351, accessLimit = 100)
public class RankingChengZhanSimilarProcess50351 extends CharacterMsgProcessor implements IThreadProcessor {
	@Override
	public void process(Hero character, RequestMsg request) throws Exception {
		...
		int pagecount = 0;
		// character 人物角色
		List<CharacterRanking> list = RankingManager.getInstance().getMapCharacterRankingChengZhanList().get((int) character.getGrade());
