 ...
 * 
 */
@MsgCodeAnn(msgcode = 50305, accessLimit = 100)
public class RankingCopperProcess50305 extends CharacterMsgProcessor implements IThreadProcessor {
	@Override
	public void process(Hero character, RequestMsg request) throws Exception {
		...
		List<CharacterRanking> list = RankingManager.getInstance().getCharacterRankingMoneyList();
