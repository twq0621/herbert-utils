 ...
 * 
 */
@MsgCodeAnn(msgcode = 50309, accessLimit = 100)
public class RankingHorseProcess50309 extends CharacterMsgProcessor implements IThreadProcessor {
	@Override
	public void process(Hero character, RequestMsg request) throws Exception {
		...
		List<HorseCharacterView> list = RankingManager.getInstance().getCharacterRankingMaList();
