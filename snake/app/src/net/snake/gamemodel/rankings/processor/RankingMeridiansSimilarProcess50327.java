...
import net.snake.gamemodel.rankings.response.RankingResponse50326;
 ...
 * 
 */
@MsgCodeAnn(msgcode = 50327, accessLimit = 100)
public class RankingMeridiansSimilarProcess50327 extends CharacterMsgProcessor implements IThreadProcessor {
	@Override
	public void process(Hero character, RequestMsg request) throws Exception {
		...
		int pagecount = 0;
		// character 人物角色
		List<CharacterRanking> list = RankingManager.getInstance().getMapcharacterRankingJingMaiList().get((int) character.getGrade());
		...
		RankingResponse50326 response50326 = new RankingResponse50326(list, mingci, pagecount);
		character.sendMsg(response50326);
