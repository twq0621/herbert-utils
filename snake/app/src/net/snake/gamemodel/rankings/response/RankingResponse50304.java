...
public class RankingResponse50304 extends ServerResponse {

	private static int msgcode = 50304;


	public RankingResponse50304(List<CharacterRanking> characters,int mingci,int pagecount) {
