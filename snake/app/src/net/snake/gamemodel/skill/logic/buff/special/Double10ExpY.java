 ...
 *
 */
public class Double10ExpY extends Buff {

	public Double10ExpY(EffectInfo effect) {
		super(effect);
	}

	@Override
	public boolean enter(EffectController controller) {
		controller.setDouble10Exp(true);
		return true;
	}

	@Override
	public boolean leave(EffectController controller) {
		controller.setDouble10Exp(false);
		return true;
	}
	...
	public boolean init(EffectController controller) {
		...
		if (character.getDoubExpNum() >= 4) {
			character.sendMsg(new PrompMsg(TipMsg.MSGPOSITION_RIGHT,20084));
			return false;
		}
		return true;
	}
