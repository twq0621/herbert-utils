...
public class Dazhaiguiying_SceneLoop implements IEventListener {

	private static int[] pos1 = { 60, 51, 61, 32 };
	private static int[] pos2 = { 61, 32 };

	private static int[] monsterIds = { 70100380 };
		...
		if (now >= timestamp) {
			...
			if (counter == 9) {
				...
				if (size == 1) {
					...
					SMonster sceneMonster = api.createMonsterToScene(71000362, pos2[0], pos2[1], 7, 1, 1, false, scene);
			...
			SMonster sceneMonster1 = api.createMonsterToScene(monsterIds[0], pos1[0], pos1[1], 7, 1, 1, false, scene);
			SMonster sceneMonster2 = api.createMonsterToScene(monsterIds[0], pos1[0], pos1[1], 7, 1, 1, false, scene);

			SMonster sceneMonster3 = api.createMonsterToScene(monsterIds[0], pos1[2], pos1[3], 7, 1, 1, false, scene);
			SMonster sceneMonster4 = api.createMonsterToScene(monsterIds[0], pos1[2], pos1[3], 7, 1, 1, false, scene);
