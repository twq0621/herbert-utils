 ...
 * 
 */
public class MyServerResponse implements MyResponseMsg {
	protected static final Logger logger = Logger.getLogger(MyServerResponse.class);
	...
	private static void needMoreBuffer(MyServerResponse msg, int bytes) {
