package gear.net {
	...
	public final class AssetData {
		 ...
		 * 位图九宫格的缩放区域
		 */
		private var _scaleBitmapRect:Rectangle=new Rectangle();
		/**
		 * 构造函数
		 * 
		...
		public function set scaleBitmapRect(scaleBitmapRect : *) : void {
			_scaleBitmapRect = scaleBitmapRect;
		}

		public function get scaleBitmapRect() : * {
			return _scaleBitmapRect;
		}
	}
}
