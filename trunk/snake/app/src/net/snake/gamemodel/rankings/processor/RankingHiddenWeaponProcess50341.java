 ...
 * 
 */
@MsgCodeAnn(msgcode = 50341, accessLimit = 100)
public class RankingHiddenWeaponProcess50341 extends CharacterMsgProcessor implements IThreadProcessor {
	@Override
	public void process(Hero character, RequestMsg request) throws Exception {
		...
		int pagecount = 0;
		// character 人物角色
		List<HiddenWeaponDataEntry> list = RankingManager.getInstance().getCharacterRankingAnQiList();
