...
import net.snake.gamemodel.rankings.response.RankingResponse50356;
 ...
 * 
 */
@MsgCodeAnn(msgcode = 50357, accessLimit = 100)
public class RankingLunJianSimilarProcess50357 extends CharacterMsgProcessor implements IThreadProcessor {
	@Override
	public void process(Hero character, RequestMsg request) throws Exception {
		...
		int pagecount = 0;
		// character 人物角色
		List<CharacterRanking> list = RankingManager.getInstance().getMapCharacterRankingLunJianList().get((int) character.getGrade());
		...
		RankingResponse50356 response50356 = new RankingResponse50356(list, mingci, pagecount);
		character.sendMsg(response50356);
