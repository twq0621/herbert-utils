 ...
 * 
 */
@MsgCodeAnn(msgcode = 50313, accessLimit = 100)
public class RankingPrestigeProcess50313 extends CharacterMsgProcessor implements IThreadProcessor {
	@Override
	public void process(Hero character, RequestMsg request) throws Exception {
		...
		int pagecount = 0;
		// character 人物角色
		List<CharacterRanking> list = RankingManager.getInstance().getCharacterRankingZhanChangList();
