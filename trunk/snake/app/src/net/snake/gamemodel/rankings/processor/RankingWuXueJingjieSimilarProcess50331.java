...
import net.snake.gamemodel.rankings.response.RankingResponse50328;
 ...
 * 
 */
@MsgCodeAnn(msgcode = 50331, accessLimit = 100)
public class RankingWuXueJingjieSimilarProcess50331 extends CharacterMsgProcessor implements IThreadProcessor {
	@Override
	public void process(Hero character, RequestMsg request) throws Exception {
		...
		int pagecount = 0;
		// character 人物角色
		List<CharacterRanking> list = RankingManager.getInstance().getMapcharacterRankingWuGongJingJieList().get((int) character.getGrade());
		...
		RankingResponse50328 response50328 = new RankingResponse50328(list, mingci, pagecount);
		character.sendMsg(response50328);
