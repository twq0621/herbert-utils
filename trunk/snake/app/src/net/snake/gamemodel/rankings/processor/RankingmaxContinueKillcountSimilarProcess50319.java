...
import net.snake.gamemodel.rankings.response.RankingResponse50318;
 ...
 * 
 */
@MsgCodeAnn(msgcode = 50319, accessLimit = 100)
public class RankingmaxContinueKillcountSimilarProcess50319 extends CharacterMsgProcessor implements IThreadProcessor {
	@Override
	public void process(Hero character, RequestMsg request) throws Exception {
		...
		int pagecount = 0;
		// character 人物角色
		List<CharacterRanking> list = RankingManager.getInstance().getMapcharacterRankingLianZhanList().get((int) character.getGrade());
		...
		RankingResponse50318 response50318 = new RankingResponse50318(list, mingci, pagecount);
		character.sendMsg(response50318);
