...
public class RankingResponse50314 extends ServerResponse {

	private static int msgcode = 50314;


	public RankingResponse50314(List<CharacterRanking> characters ,int mingci,int pagecount) {
		...
		try {
			...
			for (CharacterRanking character : characters) {
					...
					writeInt(character.getPrestige());
