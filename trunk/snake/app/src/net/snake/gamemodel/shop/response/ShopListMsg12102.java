...
public class ShopListMsg12102 extends ServerResponse {

	public ShopListMsg12102(int type, int countMonney, List<Shop> list) {
		this.setMsgCode(12102);
		this.writeByte(type);
		...
		for (Shop shop : list) {
			...
			this.writeBoolean(shop.isTimeExpression());
		}
	}
}
