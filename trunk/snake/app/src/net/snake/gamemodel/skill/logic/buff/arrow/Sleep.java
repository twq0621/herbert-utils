...
public class Sleep extends Buff {
	...
	public Sleep(EffectInfo effect) {
		super(effect);
	}
	...
	public boolean enter(EffectController controller) {
		...
		controller.setSleep(true);
		Collection<Hero> chars=affecter.getEyeShotManager().getEyeShortObjs(SceneObj.SceneObjType_Hero);
		NetTool.sendToCharacters(chars, new ImmbMsg10162(ImmbMsg10162.Effect_Chenshui, affecter));
		return true;
	}
	...
	public boolean leave(EffectController controller) {
		VisibleObject affecter = controller.getVo();
		controller.setSleep(false);
		Collection<Hero> chars=affecter.getEyeShotManager().getEyeShortObjs(SceneObj.SceneObjType_Hero);
		NetTool.sendToCharacters(chars, new CancelImmbMsg10154(ImmbMsg10162.Effect_Chenshui, affecter));
		return true;
	}
