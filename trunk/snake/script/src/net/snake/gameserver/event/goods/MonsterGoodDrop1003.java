...
public class MonsterGoodDrop1003 implements IEventListener {
	private static final Logger logger = Logger.getLogger(MonsterGoodDrop1003.class);
	public final int dropGoodScripNum = 1003;

	public final String startTime = "2011-06-14 00:00:00";
	public final String lostTime = "2011-06-16 23:59:59";
	//礼金兑换掉落配置
	public final int actionType1=102; // 兑换礼金物品掉落数量类型
	public final int dropGoodA = 21004; //
	public final int actionType1Count=200; // 兑换礼金物品掉落数量
    public final int bad1Count=200;
    public final int jilvA=10000;
    
    //道具兑换掉落配置
	public final int actionType2=103; // 兑换奖励物品掉落数量类型
	public final int dropGoodB = 21010; // 道具兑换掉落物品id
    public final int bad2Count=20; //包裹掉落物品数量上限
    public final int actionType2Count=20; // 兑换奖励物品掉落数量上限
    public final int jilvB=1000;  //几率
...
//	}
	...
	private void dropGoodTypeA(SApi api, SRole role,int actionType,int dropGood,int actionCount,int badCount,int jilv) {
		...
		if (b) {
			SGoods good = api.createCharacterGood(dropGood, 1, 0, 1,
