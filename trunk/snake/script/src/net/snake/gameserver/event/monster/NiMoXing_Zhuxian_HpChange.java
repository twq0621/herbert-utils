...
public class NiMoXing_Zhuxian_HpChange implements IEventListener {
	private final int MonsterID = 1500;// 尼摩星的怪物模型ID
	...
	public void handleEvent(SApi api, Object[] args) {
		...
		if (monster.getModel() == MonsterID) {
			...
			if (Math.random() < 0.2) {
				api.addMonsterDefence(monster, 300, 5);
				api.addMonsterDogde(monster, 500, 5);
